            ...
            <div class="card card-primary">
                ...
                <form action="{{route('service.update',$services->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                        <img src="{{asset('logos/'.$services->logo) ?? ''}}" width="100" height="100">
                            <label for="logo">Logo</label>
                            <input type="text" name="logo" class="form-control" value="{{$services->logo}}">          
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                        <img src="{{asset('images/'.$services->image) ?? ''}}" width="100" height="100">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select form-control" id="Status" name="status">
                                <option value="0" {{ ($services->status == 0) ? 'selected' : ''  }} >Non-Active</option>
